...
?>
<form action="assigment5.php" method="post" >
...
<input style="min-width: 99%;" name="" type="text" id="textfield2" value="<?php if (isset($nghiem)) echo $nghiem; 
?>" /></td></tr>
<tr>
